            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:eb44d35f729e7ad09233d64fd89efbbaca054980@sha256:648ac4150a2142359c723db34029ee02e99516f596cf23748e281741843277a9"
                    }
                }
            }
        }
