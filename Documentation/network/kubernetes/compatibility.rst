...
Once the release branch gets created from the development branch, Kubernetes
versions Cilium runs e2e tests against for that release branch get finalized.
Cilium typically does not change the Kubernetes versions it uses to run e2e
tests for the entire support period of the release.
